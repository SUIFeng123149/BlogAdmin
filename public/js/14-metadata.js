        ...
        function autoGeneratePostMetadata() {
          ...
          if(!postCategoryField.value && postForm.elements.contentSection.value) postCategoryField.value=availablePostCategories(postForm.elements.contentSection.value)[0]||"";
