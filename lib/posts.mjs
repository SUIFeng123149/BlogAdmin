...
export function serializePost(data, knownSections) {
	const title = String(data.title || "").trim();
	if (!title) throw new Error("Article title is required");
	const allowedSections = knownSections || sections;
	if (data.contentSection && !allowedSections.has(data.contentSection))
